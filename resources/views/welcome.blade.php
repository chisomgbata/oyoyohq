<x-layout-base>
    ...
    <div class="flex justify-center relative mb-10">
        <div class="xl:flex-shrink-0 w-full container px-4 md:px-12 xl:px-4 xl:mx-24 relative">
    ...
    <div class="container mx-auto px-4">
        <div class="flex items-center flex-wrap -mx-4 pb-6">
            <div class="w-full sm:w-1/2 lg:w-1/4 p-4">
                <div class="flex items-center lg:justify-center gap-4">
                    <div
                        class="flex-shrink-0 bg-orange-500 w-12 h-12 rounded-full flex items-center justify-center">
            ...
            <div class="w-full sm:w-1/2 lg:w-1/4 p-4">
                <div class="flex items-center lg:justify-center gap-4">
                    ...
                    <div><p class="text-slate-500 font-semibold">Secure Shopping</p>
                        <p class="text-slate-400 text-sm font-medium">100% Guarantee</p></div>
                </div>
            </div>
            <div class="w-full sm:w-1/2 lg:w-1/4 p-4">
                <div class="flex items-center lg:justify-center gap-4">
                    ...
                    <div><p class="text-slate-500 font-semibold">Customer Satisfaction</p>
                        <p class="text-slate-400 text-sm font-medium">100% Positive Feedbacks</p></div>
                </div>
            </div>
            <div class="w-full sm:w-1/2 lg:w-1/4 p-4">
                <div class="flex items-center lg:justify-center gap-4">
                    ...
                    <div><p class="text-slate-500 font-semibold">Support</p>
                        <p class="text-slate-400 text-sm font-medium">Online Support 24/7</p></div>
                </div>
            </div>
        </div>
    </div>
